...
**Code:**
MIT License Copyright (c) 2025 Lucas-Code
...
#### Contributions:
This is not for contributing to one larger game this is so you can take it and make your own version or mod it

##### Credits:
A game by Lucas-Code (Lucas-Code27 on github)
